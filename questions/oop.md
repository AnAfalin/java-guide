...
>Пусть требуется создать физическую модель, описывающую сталкивающиеся шары разных размеров. Традиционный подход к 
...
+ __«является»__ - is a - подразумевает наследование.  
